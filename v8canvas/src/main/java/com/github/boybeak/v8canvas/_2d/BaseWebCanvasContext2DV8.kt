package com.github.boybeak.v8canvas._2d
...
import com.github.boybeak.canvas.image.HTMLImageElement
...
import com.github.boybeak.v8canvas._2d.gradient.V8CanvasGradient
import com.github.boybeak.v8canvas.image.V8HTMLImageElement
import com.github.boybeak.v8canvas.image.V8ImageData
import com.github.boybeak.v8x.binding.V8Binding
import com.github.boybeak.v8x.binding.annotation.V8Method
import java.lang.IllegalArgumentException
import kotlin.math.abs

open class BaseWebCanvasContext2DV8(final override val canvas: IWebCanvasV8) : IWebCanvasContextV8 {

    internal val context2D: IWebCanvasContext2D = canvas.getContextAs("2d")
    private val v8: V8 get() = canvas.v8
    ...
    /** Path related **/
    @V8Method
    open fun beginPath() = context2D.beginPath()
